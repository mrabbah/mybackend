...
@RestController
@RequestMapping("/api/mybackend-kafka")
public class MybackendKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MybackendKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MybackendKafkaResource(KafkaProperties kafkaProperties) {
