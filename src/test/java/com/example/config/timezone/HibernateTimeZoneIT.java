...
import com.example.MybackendApp;
import com.example.config.TestSecurityConfiguration;
 ...
 */
@SpringBootTest(classes = {MybackendApp.class, TestSecurityConfiguration.class})
